...
public class Tc_RF_001 {
	...
	public void  verifyRegisterWithMandatoryFields() 
	{
		...
		driver.findElement(By.id("input-firstname")).sendKeys("Kajal");
		driver.findElement(By.id("input-lastname")).sendKeys("Makhija");
		...
		String actualProperDetailsTwo="You can now take advantage of member privileges to enhance your online shopping experience";
